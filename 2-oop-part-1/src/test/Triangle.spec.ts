...
describe("Triangle", () => {
  ...
  it("should tell if the triangle is equilateral", () => {
    ...
    //Note Jhoan, I had to modify the point 5.196 due doesn't never be a equilateral despite I used Epsilon
    expect(new Triangle(new Point(0, 0), new Point(6, 0), new Point(3, Math.sqrt(27))).getType()).toBe("equilateral triangle");
  });
